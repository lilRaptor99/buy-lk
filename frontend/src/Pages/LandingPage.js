        ...
        <div className="landingpage-body">
            <div id="LpageCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#LpageCarousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                    <button type="button" data-bs-target="#LpageCarousel" data-bs-slide-to="1" class="slide2" aria-label="Slide 2"></button>
                </div>
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src={require('../assets/clothing_1.jpg')} height="900px" class="d-block w-100" alt="..."/>
                    <div class="carousel-caption d-flex flex-column gap-4 align-items-center">
                        <h1>Freshen Up Your Look</h1>
                        <Link to='/kids' className='btn-Shop'><p1>Shop Here</p1></Link>
                    </div>
                    </div>
                    <div class="carousel-item">
                        <img src={require('../assets/clothing_2.jpg')} height="900px" class="d-block w-100" alt="..."/>
                        <div class="carousel-caption d-flex flex-column gap-4 align-items-center">
                            <h1>Sell Your Products<br/> Hassle-free</h1>
                            <Link to='/advertise' className='btn-Shop'><p1>Advertise</p1></Link>
                        </div>
                    </div>
                </div>
